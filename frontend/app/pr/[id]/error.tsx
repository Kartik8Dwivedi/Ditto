...
/**
 * Mirrors app/repo/[repoId]/error.tsx. Next 16.2 passes `unstable_retry`, which
 * re-fetches and re-renders the segment (`reset` only clears error state without
 * re-fetching). Verified against
...
export default function PrError({
  ...
  useEffect(() => {
    console.error('[ditto] PR analysis page failed', error);
  }, [error]);
      ...
      <div className="w-full max-w-md">
        <div className="mb-3 flex items-center gap-2">
          ...
          <h1 className="font-mono text-[13px] font-semibold text-ink">
            Could not load this PR analysis
          </h1>
        </div>
